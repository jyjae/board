...
<input name="BOARD_NAME" id="board_name" value="${id }" readOnly type="text" placeholder="Enter board_name" maxlength="30"  class="form-control">
</div>
...
<input name="BOARD_SUBJECT" id="board_subject" type="text" maxlength="100" class="form-control" placeholder="Enter board_pass">
</div>
<div class="form-group">
